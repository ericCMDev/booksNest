...
class BookSearchManager {
    func getBookInfo(isbn: String, completionBlock: @escaping (BooksAPI) -> Void) {
    ...
    func getBookInfoByTitle(title: String, completionBlock: @escaping (BooksAPI) -> Void) {
        /* Configure session, choose between:
           * defaultSessionConfiguration
           * ephemeralSessionConfiguration
           * backgroundSessionConfigurationWithIdentifier:
        ...
        /* Create the Request:
           Title (GET https://www.googleapis.com/books/v1/volumes)
         */
